...
RSpec.describe "index page", type: :feature do
  ...
  before :each do
    RentalProperty.create!(:title => "abhorrent", :price => 1.50, :maxpersons => 10, :latitude => 7.698744, :longitude => -0.593262, :bathrooms => 3)
    RentalProperty.create!(:title => "gorgeous", :price => 3.50, :maxpersons => 8, :latitude => 6.434036, :longitude => 16.501465, :bathrooms => 3)
    RentalProperty.create!(:title => "lovely", :price => 0.50, :maxpersons => 6, :latitude => 42.8270, :longitude => -75.5446, :bathrooms => 4)
    RentalProperty.create!(:title => "stinky", :price => 2.30, :maxpersons => 4, :latitude => 35.807790, :longitude => -5.559082, :bathrooms => 4)

    allow_any_instance_of(RentalPropertiesController).to receive(:session).and_return({:geo_location => {"success" => true, "latitude" => 42.8270, "longitude" => -75.5446}} )
